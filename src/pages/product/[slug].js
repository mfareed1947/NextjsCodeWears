      ...
      <section class="text-gray-400 bg-white body-font overflow-hidden">
        <div class="container px-5 py-24 mx-auto">
          <div class="lg:w-4/5 mx-auto flex flex-wrap">
            <img alt="ecommerce" class="lg:w-1/2 w-full lg:h-auto px-20 object-cover object-top rounded" src="https://m.media-amazon.com/images/I/514FIcngROL._AC_UX569_.jpg" />
            <div class="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
              ...
              <div class="flex mt-6 items-center pb-5 border-b-2 border-gray-800 mb-5">
                <div class="flex">
                  ...
                  <button class="border-2 border-gray-800 ml-1 bg-pink-500 rounded-full w-6 h-6 focus:outline-none"></button>
                </div>
                <div class="flex ml-6 items-center">
                  <span class="mr-3">Size</span>
                  <div class="relative">
                    <select class="rounded border border-gray-700 focus:ring-2 focus:ring-pink-900 bg-transparent appearance-none py-2 focus:outline-none focus:border-pink-500 text-black pl-3 pr-10">
                      <option>SM</option>
                      <option>M</option>
                      <option>L</option>
                      <option>XL</option>
              ...
              <div class="flex">
                <span class="title-font font-medium text-xl text-black">Rs 1600</span>
                <button class="flex ml-6 text-white bg-pink-500 border-0 py-2 px-3 md:px-6 focus:outline-none hover:bg-pink-600 rounded">Add to Cart</button>
                <button class="flex ml-6 text-white bg-pink-500 border-0 py-2 px-3 md:px-6 focus:outline-none hover:bg-pink-600 rounded">Buy Now</button>
              ...
              <div className="flex mt-6 space-x-2">
                <input placeholder='Enter your Pincode' onChange={(e) => { setPin(e.target.value) }} type="text" className='border-2 border-pink-300 rounded-md' />
